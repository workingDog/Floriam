...
Adjust how many images to keep in your **History** if desired, the default is 10.

Secondly, toggle the **Identify/Disease** to identify the **plant** or the **plant disease** from the picture. 

Then, select the **Camera** or **Photos**.

Multiple photo selections (up to 3) from the **Photos App** can used to identify **one** plant or plant didease.  

When using the **Camera**, only the one picture is used to identify the plant or plant didease.

A long press on a picture will bring the **Share** panel.

Tap on the results (bottom panel) to get more information. Google AI Gemini when available, can provide additional information about the plant or the plant disease.
...
-   A **Google Gemini key** can also be used if desired, see [Google AI key](https://ai.google.dev/gemini-api/docs/api-key). When available, the AI is used to provide more information about the identified plants and or plants diseases.
...
-    [Textual](https://github.com/gonzalezreal/textual) to display Markdown
